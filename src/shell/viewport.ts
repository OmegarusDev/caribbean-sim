 ...
 * The stage canvas is resized to its CSS box × DPR (capped).
 */
...
/** Resize stage drawingBuffer to CSS box × DPR. Returns CSS dims. */
export function resizeStageCanvas(stage: HTMLCanvasElement): { cssW: number; cssH: number } {
